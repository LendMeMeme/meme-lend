      ...
      <div className="grid section">
        ...
        <aside className="span-5">
          <div className="card panel warning">
            ...
            a market does not verify or endorse that collateral. The protocol oracle publishers,
            LLTV, caps, fees, and rate curve cannot be edited afterward.
          </div>
          <div className="card panel" style={{ marginTop: 16 }}>
            <h3>After creation</h3>
            <p className="muted">
              The managed oracle must establish a safe multi-source price before borrowing can
              begin. You can then seed USDC liquidity, add memecoin lender rewards, and deposit a
              first-loss USDC reserve.
            </p>
          </div>
        </aside>
      </div>
