...
/// 20,000,000% APR expressed as a RATE_SCALE multiplier (200,000x principal/year).
pub const MAX_BORROW_APR: u128 = 200_000 * RATE_SCALE;
...
pub const RATE_SHAPE_LINEAR: u8 = 1;
pub const RATE_SHAPE_QUADRATIC: u8 = 2;
pub const RATE_SHAPE_CUBIC: u8 = 3;
